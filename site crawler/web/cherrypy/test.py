...
print("     Résultats du crawling de la page 1 : ","Mot : ", level1.results[0][2], ", nombre d'occurences du mot : ", level1.results[0][0], ",pourcentage de présence du mot : ", level1.results[0][1],"%")
print("     Résultats du crawling de la page 1 : ","Mot : ", level1.results[1][2], ", nombre d'occurences du mot : ", level1.results[1][0], ",pourcentage de présence du mot : ", level1.results[1][1],"%")
print("     Résultats du crawling de la page 1 : ","Mot : ", level1.results[2][2], ", nombre d'occurences du mot : ", level1.results[2][0], ",pourcentage de présence du mot : ", level1.results[2][1],"%")
